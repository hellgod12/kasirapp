      ...
      <main className="flex-1 overflow-auto pb-20 md:pb-0">
        <div className="p-4 md:p-8">
          <div className="mb-6 md:mb-8">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Riwayat Stok</h1>
            <p className="text-gray-600 mt-1 text-sm md:text-base">Lihat semua pergerakan stok barang</p>
          </div>
