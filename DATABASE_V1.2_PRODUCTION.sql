-- ============================================================================
-- KasirApp Database Schema v1.2 - Production Migration (Enterprise Standard)
-- ============================================================================
-- Version: 1.2.0
-- Date: July 18, 2026
-- Description: Production-grade migration following enterprise PostgreSQL standards
-- 
-- Execution Order:
-- 1. Extensions
-- 2. Enums
...
-- use MIGRATION_ROADTO_V1.2.md for zero data loss migration.
-- ============================================================================
...
-- No custom enums in this schema

-- ============================================================================
-- SECTION 3: Tables (without foreign keys)
-- ============================================================================
...
-- All columns are defined in CREATE TABLE statements
-- No additional column additions needed
...
-- ============================================================================
-- SECTION 10: Policies (Row Level Security)
-- ============================================================================
...
('1.2.0', md5(current_timestamp::text), 'Initial production schema v1.2 (enterprise standard, syntax errors fixed)')
...
AND table_name IN (
  'schema_migrations', 'profiles', 'categories', 'payment_methods', 'settings',
  'products', 'sales', 'sale_items', 'stock_movements', 'suppliers',
  'daily_production', 'waste_items', 'customers', 'discounts',
  'raw_materials', 'product_recipes', 'expenses', 'transaction_logs'
);

-- Verify all foreign keys created
SELECT 'Foreign keys created successfully' as status, COUNT(*) as fk_count
...
SELECT 'Triggers created successfully' as status, COUNT(*) as trigger_count
